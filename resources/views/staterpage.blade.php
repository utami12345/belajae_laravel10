      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="data-pegawai" class="nav-link active">
                  <p>Data Pegawai</p>
                </a>
              </li>
        </ul>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['pegawai_jabatan'];?></td>
                        <td><?php echo $data['pegawai_umur'];?></td>
                        <td><?php echo $data['pegawai_alamat'];?></td>
                        <td>
                        <a class="btn btn-warning btn-sm" href="/pegawai/edit/<?php echo $data['pegawai_id']; ?>">Edit</a>
                        <a class="btn btn-danger btn-sm" href="/pegawai/hapus/<?php echo $data['pegawai_id']; ?>">Hapus</a>
                        </td>
                </tr>
